metadata description = 'Provisions resources for a web application that uses Azure SDK for Python to connect to Azure Cosmos DB for MongoDB.'
...
var tags = {
  ...
  repo: 'https://github.com/azure-samples/cosmos-db-mongodb-python-quickstart'
}
